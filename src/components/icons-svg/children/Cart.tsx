// icon:bxs-id-card | Boxicons https://boxicons.com/ | Atisa
import * as React from "react";

function IconBxsIdCard(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="#2dbe60" height="40" width="40" {...props}>
